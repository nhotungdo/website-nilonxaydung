        ...
        <div className="container max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex gap-4">
              ...
              <button className="bg-white text-primary font-bold py-3 px-6 rounded-md hover:bg-gray-100 transition-colors">
                Xem Catalogue
              </button>
            </div>
          </div>
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm text-gray-300">
                <li className="flex items-start">
                  ...
                  <span>123 Đường Công Trường, Quận 9, TP. HCM</span>
                </li>
