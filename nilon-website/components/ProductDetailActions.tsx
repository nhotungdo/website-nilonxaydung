    ...
    <>
      <div className="flex flex-col sm:flex-row gap-4">
        <button
          ...
          className="flex-1 bg-[#2b6cb0] hover:bg-[#3182ce] text-white font-bold py-4 px-8 rounded-[12px] text-center transition-colors flex items-center justify-center gap-2 shadow-1"
        >
        ...
        <a
          ...
          className="flex-1 bg-[#1a365d] hover:bg-[#2b6cb0] text-white font-bold py-4 px-8 rounded-[12px] text-center transition-colors flex items-center justify-center gap-2 shadow-1"
        >
