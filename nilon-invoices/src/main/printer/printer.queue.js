...
export class PrinterQueue {
    ...
    printerId;
    printerName;
    constructor(printerId, printerName) {
     ...
     */
    async handlePrintFailure(job, errorMessage) {
     ...
     */
    updateJobStatus(jobId, status, printedAt = null, error = null) {
        if (printedAt) {
    ...
    notifyWebContents(jobId, status, retryCount, error) {
