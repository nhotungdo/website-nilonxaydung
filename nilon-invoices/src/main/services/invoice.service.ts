...
import { IOrderPayload, IPrintJob, IPrinter } from '../../shared/types';
...
class InvoiceService {
   ...
   */
  public async processIncomingOrder(order: IOrderPayload): Promise<void> {
   ...
   */
  private resolveTargetPrinter(order: IOrderPayload): IPrinter {
    ...
    let printer = db.prepare(`
      ...
      LIMIT 1
    `).get(paperSize) as IPrinter | undefined;
